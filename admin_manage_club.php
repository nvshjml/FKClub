...
// Fetch members
$members = $conn->query("SELECT u.user_id, u.name, c.position FROM committee c JOIN `USER` u ON c.user_id = u.user_id WHERE c.club_id = $club_id ORDER BY c.position ASC, u.name ASC");
?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-links">
                                        <a href="admin_edit_membership.php?user_id=<?php echo urlencode($m['user_id']); ?>&club_id=<?php echo $club_id; ?>" class="btn-sm btn-edit">Edit</a>

...
if (isset($_POST['update_event'])) {
    ...
    if ($update_stmt->execute()) {
        ...
        $message = "<div style='background:#fed7d7; color:#822727; padding:12px; border-radius:8px; margin-bottom:20px;'>❌ Update failed.</div>";
    }

    if ($update_stmt->execute()) {
    $message = "<div style='background:#c6f6d5; color:#22543d; padding:12px; border-radius:8px; margin-bottom:20px;'>✏️ Event updated successfully! Description: " . htmlspecialchars($description) . "</div>";
} else {
...
<head>
    ...
    <style>
        * { box-sizing: border-box; font-family: 'Inter', sans-serif; margin: 0; padding: 0; }
        ...
        .modal-content input, .modal-content textarea { width: 100%; padding: 12px; margin-bottom: 15px; border: 2px solid #e2e8f0; border-radius: 8px; }
        .btn-submit { background: #3182ce; color: white; padding: 12px 20px; border: none; border-radius: 8px; cursor: pointer; }
        .btn-cancel { background: #e2e8f0; color: #4a5568; padding: 12px 20px; border: none; border-radius: 8px; cursor: pointer; margin-left: 10px; }
    </style>
</head>
<body>
            ...
            ?>
                <div class="event-card">
                    ...
                    <div class="event-content">
                        ...
                        <div class="event-detail">📝 <?php echo htmlspecialchars($event['description']); ?></div>
...
<div id="createModal" class="modal">
    <div class="modal-content">
        ...
        <form method="POST">
            ...
            <button type="submit" name="create_event" class="btn-submit">Create</button>
...
<div id="editModal" class="modal" style="display: flex;">
    <div class="modal-content">
        ...
        <form method="POST">
            ...
            <a href="committee_events.php" class="btn-cancel" style="text-decoration:none;">Cancel</a>
        </form>
    </div>
</div>
<?php endif; ?>

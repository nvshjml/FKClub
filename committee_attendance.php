...
if ($club_id) {
    ...
    $event_query->bind_param("s", $club_id);
    $event_query->execute();
...
if (isset($_POST['mark_attendance'])) {
    ...
    if ($check->get_result()->num_rows > 0) {
        ...
        elseif ($status === 'Volunteer') $points = 15;
        elseif ($status === 'Absent') $points = -10;
...
if ($selected_event_id) {
    ...
    $student_stmt->bind_param("s", $selected_event_id);
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card">
                ...
                <select name="event_id" onchange="this.form.submit()">
                    ...
                    <?php if ($events && is_object($events) && $events->num_rows > 0): ?>
                        <?php while($e = $events->fetch_assoc()): ?>
                            <option value="<?php echo htmlspecialchars($e['event_id']); ?>" <?php echo ($selected_event_id === $e['event_id']) ? 'selected' : ''; ?>>
            ...
            <?php if ($events && is_object($events) && $events->num_rows === 0 && $club_id): ?>
            ...
            <?php if ($club_id && $events && is_object($events) && $events->num_rows > 0): ?>
